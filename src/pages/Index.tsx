  ...
  return (
    <div className="min-h-screen bg-gradient-snow dark:bg-gradient-cozy transition-colors duration-500 relative">
      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        <FadeInSection>
          <header className="text-center mb-8 backdrop-blur-sm bg-card/30 dark:bg-card/20 rounded-3xl p-8 border border-border/50 shadow-festive dark:shadow-warm mx-auto max-w-4xl">
        ...
        <FadeInSection>
          <section className="mb-12 backdrop-blur-sm bg-card/40 dark:bg-card/30 rounded-3xl p-6 border border-border/50 shadow-festive dark:shadow-warm mx-auto max-w-4xl overflow-hidden">
      ...
      <FadeInSection>
        <footer className="text-center py-8 text-muted-foreground">
          <p className="text-sm">
            Made with <span className="text-primary dark:text-accent">❤</span>{" "}
            for our Christmas gift exchange
          </p>
        </footer>
      </FadeInSection>
    </div>
